...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452' => 'get1Db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452Service',
            '2_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452' => 'get2Db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452Service',
            ...
            'config.table_prefix.subscriber' => 'getConfig_TablePrefix_SubscriberService',
            ...
            'content.manager' => 'getContent_ManagerService',
            ...
            'hook.twig.extension' => 'getHook_Twig_ExtensionService',
            ...
            'template.asset_manager' => 'getTemplate_AssetManagerService',
            'template.manager' => 'getTemplate_ManagerService',
        ...
        $this->privates = array(
            '1_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452' => true,
            '2_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452' => true,
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TemplateBundle', ($this->targetDirs[3].'\\app/Resources/TemplateBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TemplateBundle', ($this->targetDirs[3].'\\src\\TemplateBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ConfigBundle', ($this->targetDirs[3].'\\app/Resources/ConfigBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ConfigBundle', ($this->targetDirs[3].'\\src\\ConfigBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'RouteBundle', ($this->targetDirs[3].'\\app/Resources/RouteBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'RouteBundle', ($this->targetDirs[3].'\\src\\RouteBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ModuleBundle', ($this->targetDirs[3].'\\app/Resources/ModuleBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ModuleBundle', ($this->targetDirs[3].'\\src\\ModuleBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HookBundle', ($this->targetDirs[3].'\\app/Resources/HookBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HookBundle', ($this->targetDirs[3].'\\src\\HookBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ContentBundle', ($this->targetDirs[3].'\\app/Resources/ContentBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ContentBundle', ($this->targetDirs[3].'\\src\\ContentBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        })), $c, array(($this->targetDirs[3].'/templates/') => 'Template')), 6 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this, new \Symfony\Bundle\TwigBundle\TemplateIterator($a, ($this->targetDirs[3].'\\app'), array(($this->targetDirs[3].'/templates/') => 'Template'))), 7 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->get('doctrine')) && false ?: '_'})));
    }

    /**
     * Gets the public 'config.manager' shared service.
     *
     * @return \ConfigBundle\Service\ConfigurationManager
     */
    protected function getConfig_ManagerService()
    {
        return $this->services['config.manager'] = new \ConfigBundle\Service\ConfigurationManager(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }

    /**
     * Gets the public 'config.table_prefix.subscriber' shared service.
     *
     * @return \ConfigBundle\Subscriber\TablePrefixSubscriber
     */
    protected function getConfig_TablePrefix_SubscriberService()
    {
        return $this->services['config.table_prefix.subscriber'] = new \ConfigBundle\Subscriber\TablePrefixSubscriber('cms_');
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452']) ? $this->services['1_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452'] : $this->get1Db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452']) ? $this->services['2_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452'] : $this->get2Db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', array(0 => function () {
            return ${($_ = isset($this->services['extension.listener']) ? $this->services['extension.listener'] : $this->get('extension.listener')) && false ?: '_'};
        }, 1 => 'onLateKernelRequest'), -10);
        $instance->addListener('kernel.request', array(0 => function () {
            return ${($_ = isset($this->services['extension.listener']) ? $this->services['extension.listener'] : $this->get('extension.listener')) && false ?: '_'};
        }, 1 => 'onKernelRequest'), 0);
        $instance->addListener('console.command', array(0 => function () {
            return ${($_ = isset($this->services['extension.listener']) ? $this->services['extension.listener'] : $this->get('extension.listener')) && false ?: '_'};
        }, 1 => 'onConsoleCommand'), -10);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(${($_ = isset($this->services['config.table_prefix.subscriber']) ? $this->services['config.table_prefix.subscriber'] : $this->get('config.table_prefix.subscriber')) && false ?: '_'});
        ...
        $c->addEventSubscriber(${($_ = isset($this->services['gedmo.listener.loggable']) ? $this->services['gedmo.listener.loggable'] : $this->get('gedmo.listener.loggable')) && false ?: '_'});
        ...
        $c->addEventSubscriber(${($_ = isset($this->services['gedmo.listener.sortable']) ? $this->services['gedmo.listener.sortable'] : $this->get('gedmo.listener.sortable')) && false ?: '_'});
        $c->addEventSubscriber(${($_ = isset($this->services['gedmo.listener.sluggable']) ? $this->services['gedmo.listener.sluggable'] : $this->get('gedmo.listener.sluggable')) && false ?: '_'});
        ...
        $c->addEventSubscriber(${($_ = isset($this->services['gedmo.listener.translatable']) ? $this->services['gedmo.listener.translatable'] : $this->get('gedmo.listener.translatable')) && false ?: '_'});
        $c->addEventSubscriber(${($_ = isset($this->services['gedmo.listener.tree']) ? $this->services['gedmo.listener.tree'] : $this->get('gedmo.listener.tree')) && false ?: '_'});
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'custom_cms', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Translatable\\Entity'), 1 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Loggable\\Entity'), 2 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Tree\\Entity'), 3 => ($this->targetDirs[3].'\\src\\TemplateBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\ConfigBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\ModuleBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\HookBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\ContentBundle\\Entity')));
        ...
        $c->addDriver($b, 'HookBundle\\Entity');
        $c->addDriver($b, 'ContentBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('Gedmo' => 'Gedmo\\Tree\\Entity', 'TemplateBundle' => 'TemplateBundle\\Entity', 'ConfigBundle' => 'ConfigBundle\\Entity', 'ModuleBundle' => 'ModuleBundle\\Entity', 'HookBundle' => 'HookBundle\\Entity', 'ContentBundle' => 'ContentBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d229e2495abfdd0552937eb83846ed59ae606bc6e80e903a5c1192bdb3fb98f5');
     ...
     *
     * @return \ConfigBundle\Listener\DoctrineExtensionListener
     */
    protected function getExtension_ListenerService()
    {
        $this->services['extension.listener'] = $instance = new \ConfigBundle\Listener\DoctrineExtensionListener();
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('ContentBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer(${($_ = isset($this->services['swiftmailer.mailer.default']) ? $this->services['swiftmailer.mailer.default'] : $this->get('swiftmailer.mailer.default')) && false ?: '_'}, ${($_ = isset($this->services['router']) ? $this->services['router'] : $this->get('router')) && false ?: '_'}, ${($_ = isset($this->services['templating']) ? $this->services['templating'] : $this->get('templating')) && false ?: '_'}, array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('contact@custom-cms.com' => 'contact@custom-cms.com'), 'resetting' => array('contact@custom-cms.com' => 'contact@custom-cms.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('ContentBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('ContentBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('ContentBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the public 'hook.twig.extension' shared service.
     *
     * @return \HookBundle\Twig\HookExtension
     */
    protected function getHook_Twig_ExtensionService()
    {
        return $this->services['hook.twig.extension'] = new \HookBundle\Twig\HookExtension(${($_ = isset($this->services['module.manager']) ? $this->services['module.manager'] : $this->get('module.manager')) && false ?: '_'});
    }
     ...
     *
     * @return \ModuleBundle\Service\ModuleManager
     */
    protected function getModule_ManagerService()
    {
        return $this->services['module.manager'] = new \ModuleBundle\Service\ModuleManager($this, ${($_ = isset($this->services['template.manager']) ? $this->services['template.manager'] : $this->get('template.manager')) && false ?: '_'}->getAbsoluteTemplatePath(), $this->targetDirs[3]);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j->add($i, array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_ADMIN', 2 => 'ROLE_USER'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('contact@custom-cms.com');
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    /**
     * Gets the public 'template.asset_manager' shared service.
     *
     * @return \TemplateBundle\Service\AssetManager
     */
    protected function getTemplate_AssetManagerService()
    {
        return $this->services['template.asset_manager'] = new \TemplateBundle\Service\AssetManager(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel')) && false ?: '_'}, ${($_ = isset($this->services['template.manager']) ? $this->services['template.manager'] : $this->get('template.manager')) && false ?: '_'}, ${($_ = isset($this->services['request_stack']) ? $this->services['request_stack'] : $this->get('request_stack')) && false ?: '_'});
    }

    /**
     * Gets the public 'template.manager' shared service.
     *
     * @return \TemplateBundle\Service\TemplateManager
     */
    protected function getTemplate_ManagerService()
    {
        return $this->services['template.manager'] = new \TemplateBundle\Service\TemplateManager(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'}, $this->targetDirs[3]);
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->get('twig.loader')) && false ?: '_'}, array('debug' => true, 'strict_variables' => true, 'paths' => array(($this->targetDirs[3].'/templates/') => 'Template'), 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));

        $instance->addExtension(new \Twig_Extensions_Extension_Text());
        $instance->addExtension(${($_ = isset($this->services['hook.twig.extension']) ? $this->services['hook.twig.extension'] : $this->get('hook.twig.extension')) && false ?: '_'});
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, ${($_ = isset($this->services['templating.name_parser']) ? $this->services['templating.name_parser'] : $this->get('templating.name_parser')) && false ?: '_'}, true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'FOSUserBundle', 9 => 'TemplateBundle', 10 => 'ConfigBundle', 11 => 'RouteBundle', 12 => 'ModuleBundle', 13 => 'HookBundle', 14 => 'ContentBundle', 15 => 'DebugBundle', 16 => 'WebProfilerBundle', 17 => 'SensioDistributionBundle', 18 => 'SensioGeneratorBundle', 19 => 'WebServerBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/templates/'), 'Template');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2440260cd37158a824a49299fd12d86f4faf4e67');
    }
    ...
    /**
     * Gets the private '1_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1Db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452Service()
    {
        return $this->services['1_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2Db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452Service()
    {
        return $this->services['2_db51a7591ab5386c2469761899664e092af93f88054d5987b39fe3fd8de25452'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FeGS4eHYAK', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M5d-v2cz2m', 0, 'kwm1pT8mRzKDc2V3BRVtTF', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Tbq9FSrcW4', 0, 'kwm1pT8mRzKDc2V3BRVtTF', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QXXRR7lniA', 0, 'kwm1pT8mRzKDc2V3BRVtTF', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a002861260574.97980221');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'RouteBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\RouteBundle'),
                    'namespace' => 'RouteBundle',
                ),
                'ModuleBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ModuleBundle'),
                    'namespace' => 'ModuleBundle',
                ),
                'HookBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\HookBundle'),
                    'namespace' => 'HookBundle',
                ),
                'ContentBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ContentBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'RouteBundle' => 'RouteBundle\\RouteBundle',
                'ModuleBundle' => 'ModuleBundle\\ModuleBundle',
                'HookBundle' => 'HookBundle\\HookBundle',
                'ContentBundle' => 'ContentBundle\\ContentBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'custom_cms',
            'database_user' => 'root',
            'database_password' => 'root',
            'database_prefix' => 'cms_',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'contact@custom-cms.com',
            'mailer_password' => NULL,
            'secret' => '2440260cd37158a824a49299fd12d86f4faf4e67',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '2440260cd37158a824a49299fd12d86f4faf4e67',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'contact@custom-cms.com',
            ...
            'fos_user.model.user.class' => 'ContentBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'contact@custom-cms.com' => 'contact@custom-cms.com',
            ),
